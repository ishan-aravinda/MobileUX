$(function() {
    ...
    var config = [{
                ...
                "color": "white",
                "position": "TL",
                "text": "This button takes you to the game page",
                "time": 5000
            },
            {
                "name": "tour_4",
                "bgcolor": "black",
                "color": "white",
                "text": "The footer, for more info on how to contact us",
                "position": "BL",
                "time": 5000
            },
            {
            ...
            },
            {
                ...
                "bgcolor": "black",
                "color": "white",
                "text": "The navigation bar, to navigate throughout the site",
                "position": "TL",
                "time": 5000
            }
        ],
    ...
    function showTooltip() {
        ...
        var $tooltip = $('<div>', {
            id: 'tour_tooltip',
            className: 'tooltip',
            html: '<p>' + step_config.text + '</p><span style="z-index: 100;" class="tooltip_arrow"></span>'
        }).css({
            'display': 'none',
